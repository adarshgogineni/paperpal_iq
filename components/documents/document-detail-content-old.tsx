...
import { FileText, ArrowLeft, Calendar, Loader2, MessageSquare } from "lucide-react"
import { Database } from "@/lib/types/database"
import { AUDIENCES, type Audience } from "@/lib/openai/prompts"
import { ErrorBoundary } from "@/components/error-boundary"
import { ChatSessionManager } from "@/components/chat/chat-session-manager"
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {!selectedAudience && !generating && (
            ...
            {activeTab === "chat" && (
              <ChatSessionManager
                documentId={document.id}
                selectedAudience={selectedAudience || "undergraduate"}
